  ...
  return (
    ...
    >
      ...
      <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-4">
        ...
        <div
          className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${getColorClasses(
            color
          )} flex items-center justify-center shadow-xl group-hover:shadow-2xl group-hover:scale-110 transition-all duration-500 relative overflow-hidden`}
        >
          {/* Icon glow effect */}
          <div
        ...
        <div className="space-y-4">
          ...
          {change && (
            <div className="flex items-center space-x-3">
              <div
                className={`flex items-center space-x-1 px-3 py-1.5 rounded-full bg-gradient-to-r ${
              ...
              >
                <ChangeIcon
                  className={`w-4 h-4 ${getChangeColor(change.type)}`}
                />
                <span
                  className={`text-sm font-bold ${getChangeColor(change.type)}`}
                >
